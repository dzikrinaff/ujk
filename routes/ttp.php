...
.primary-btn {
    ...
    padding: 12px 30px;
    background-color: #ff0000; /* Warna asli sebelumnya */
    color: #000000;
    font-size: 16px;
    font-weight: 600;
...
.youtube_item_pic img {
    width: 100%;
    height: 100%;
    object-fit: cover; /* Memastikan gambar selalu penuh */
    transition: transform 0.3s ease-in-out;
}

.youtube_item_pic:hover img {
    transform: scale(1.1);
}

/* Tombol Play */
.youtube_item_pic .play-btn {
    font-size: 18px;
    color: #fff;
    height: 50px;
    width: 50px;
...
.youtube_item_pic .play-btn i {
    position: relative;
    top: 1px;
    left: 2px;
}

.youtube_item_pic:hover .play-btn {
...
.footer {
    padding-top: 60px; /* Sesuaikan sesuai kebutuhan */
    padding-bottom: 60px;
	...
	.social-icon {
		...
		background: #ffffff; /* Latar belakang ikon */
	...
	.social-icon:hover {
		background: #585d59; /* Warna latar belakang saat hover */
...
.tours__text__widget ul {
    list-style: none;
    padding: 0;
    margin: 0;
}

.tours__text__widget ul li {
    font-size: 15px;
    color: #000;
    display: flex;
    align-items: center;
...
@media (max-width: 768px) {
    ...
    .tours__item__text, .tours__item__pic {
        max-width: 100%;
        padding: 15px;
    }
