...
<section class="hero spad set-bg" data-setbg="{{ asset('frontend/assets/img/bg.jpeg') }}">
  <div class="container">
      <div class="row">
          <div class="col-lg-12">
...
<section class="countdown spad set-bg" data-setbg="{{ asset('frontend/assets/img/countdown-bg.jpg') }}">
  <div class="container">
      <div class="row">
          <div class="col-lg-12">
